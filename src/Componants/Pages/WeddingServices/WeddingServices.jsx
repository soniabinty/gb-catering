...
import bgImage from "../../../assets/wedding-service.jpg";
    ...
    <div>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center text-white">
          <h2 className="md:text-6xl text-4xl uppercase krona-font tracking-widest">
            {t("weddingServices2.title")}
          </h2>
        </div>
      </section>

      <section className="flex flex-col md:flex-row gap-0 px-4 py-8 max-w-6xl mx-auto bg-white">
        {/* Text Content */}
        <div className="w-full md:w-1/2">
          <div id="servicetext" className="text-gray-700 space-y-4">
            <p className="text-xl pt-2">{t("weddingServices2.intro")}</p>
          </div>
        </div>

        {/* Hidden on mobile – empty column (placeholder for image or future content) */}
          ...
          >
            ...
            <div className="absolute top-0 w-full">
              ...
              >
                ...
                <path d="M204.5,13.4c-0.1-0.1,2-1,3.2-1.1c1.2-0.1,2,0,2,0.3c0,0.3-0.1,0.5-1.6,0.4C206.4,12.9,204.6,13.5,204.5,13.4z" />
                <path d="M201,10.6c0-0.1-4.4,1.2-6.3,2.2c-1.9,0.9-6.2,3.1-6.1,3.1c0.1,0.1,4.2-1.6,6.3-2.6S201,10.7,201,10.6z" />
                <path d="M154.5,26.7c-0.1-0.1-4.6,0.3-7.2,0c-7.3-0.7-17-3.2-16.6-2.9c0.4,0.3,13.7,3.1,17,3.3C152.6,27.5,154.6,26.8,154.5,26.7z" />
                <path d="M41.9,19.3c0,0,1.2-0.3,2.9-0.1c1.7,0.2,5.8,0.9,8.2,0.7c4.2-0.4,7.4-2.7,7-2.6c-0.4,0-4.3,2.2-8.6,1.9c-1.8-0.1-5.1-0.5-6.7-0.4S41.9,19.3,41.9,19.3z" />
                <path d="M75.5,12.6c0.2,0.1,2-0.8,4.3-1.1c2.3-0.2,2.1-0.3,2.1-0.5c0-0.1-1.8-0.4-3.4,0C76.9,11.5,75.3,12.5,75.5,12.6z" />
                <path d="M15.6,13.2c0-0.1,4.3,0,6.7,0.5c2.4,0.5,5,1.9,5,2c0,0.1-2.7-0.8-5.1-1.4C19.9,13.7,15.7,13.3,15.6,13.2z" />
              </svg>
            </div>

            {/* Bottom Wave Shape Divider (Flipped Vertically) */}
      ...
      <section
        className="relative bg-fixed md:py-44 py-32 overflow-hidden bg-cover bg-center"
        style={{
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 style={{ letterSpacing: '0.2em' }} className="text-3xl krona-font md:text-4xl font-bold text-white">
              {t("weddingServices2.quote")}
            </h2>
          </div>
        </div>
      </section>
      ...
      <div className="relative w-full mx-auto">
        ...
        <div className="relative z-50 max-w-5xl mx-auto text-black -mb-32">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="bg-[#FFF4F4] p-8">
              <h1 className="text-2xl md:text-4xl font-bold mb-4 text-center uppercase">
                {t("weddingServices2.marquees.title")}
              </h1>
              <p className="text-md leading-loose text-justify tracking-widest">
                {t("weddingServices2.marquees.description")}
              </p>
            </div>
            <div className="bg-[#FFF4F4] p-8">
              <h1 className="text-2xl md:text-4xl font-bold mb-4 text-center uppercase">
                {t("weddingServices2.lighting.title")}
              </h1>
              <p className="text-md leading-loose text-justify tracking-widest">
                {t("weddingServices2.lighting.description")}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-full h-[380px] overflow-hidden shadow-lg">
          <img
            ...
            src="https://i.ibb.co/ZRZTZqK8/chandelier-with-flowers-greenery-hangs-dinner-table.jpg"
            alt={t("weddingServices2.imageAlt", { defaultValue: "Chandelier with flowers and greenery" })}
          />
        </div>
      </div>
      <NeedHelp />
